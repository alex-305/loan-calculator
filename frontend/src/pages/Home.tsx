...
const services: Service[] = [
  {
    ...
    title: "Agriculture",
    description: "Lorem ipsum odor amet, consectetuer adipiscing elit. Fusce cursus cras cras in pulvinar montes. Facilisis viverra dolor feugiat sollicitudin montes lobortis. Taciti accumsan iaculis primis nunc scelerisque dui rhoncus.",
