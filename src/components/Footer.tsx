...
function FooterTitle({ children }: FooterTitleProps) {
  return <div className="text-3xl font-semibold tracking-wide uppercase pb-3 text-white">{children}</div>;
}

function Footer() {
  return (
    <div className="pt-10 pb-10 mb-0 px-10 flex flex-row flex-grow-0 flex-shrink-0 bg-slate-900 overflow-hidden">
      <div className="w-1/3">
